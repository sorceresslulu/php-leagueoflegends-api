...
class LeaguePlayerEntryDTO
{
    ...
    public function __construct($division, $isFreshBlood, $isHotStreak, $isInactive, $isVeteran, $leaguePoints, $wins, $losses, $miniSeries, $playerOrTeamId, $playerOrTeamName)
    {
        ...
        $this->playerId = $playerOrTeamId;
        $this->playerName = $playerOrTeamName;
    }
