...
use LolAPI\Service\Team\Ver2_4\BySummonerIds\Request;
use LolAPI\Service\Team\Ver2_4\BySummonerIds\Service;
...
class BySummonerIdsTest extends ExampleTest
{
    public function testExample()
    {
        ...
        $request = new Request($this->getApiKey(), $this->getRegionalEndpoint(), array($config['summonerIdWithTeam']));
    ...
    private function processResult(BySummonerIdsDTO $dto)
    {
